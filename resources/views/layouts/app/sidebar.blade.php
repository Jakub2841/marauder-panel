        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 shadow-lg dark:border-zinc-700 dark:bg-zinc-900 dark:shadow-zinc-900/50">
            ...
            <flux:sidebar.nav>
                ...
                <flux:sidebar.group class="grid mt-4 sidebar-nav">
                    ...
                    <flux:sidebar.item icon="cog-6-tooth" :href="route('setup.edit')" wire:navigate class="data-current:text-blue-400">
                        {{ __('SETTINGS') }}
                    </flux:sidebar.item>
        ...
        <flux:header class="lg:hidden">
            ...
            <flux:dropdown position="top" align="end">
                ...
                <flux:menu>
                    ...
                    <flux:menu.radio.group>
                        <flux:menu.item :href="route('setup.edit')" icon="cog" wire:navigate>
                            {{ __('Settings') }}
                        </flux:menu.item>
                    </flux:menu.radio.group>
